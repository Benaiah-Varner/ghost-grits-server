...
import { SessionStrategy, JSONValue, SessionStoreFunction, SessionContext, CreateContext } from '@keystone-next/types';
...
export declare function withItemData<T extends {
    listKey: string;
    itemId: string;
}>(createSession: () => SessionStrategy<T>, fieldSelections?: FieldSelections): () => SessionStrategy<T & {
    data: any;
}>;
export declare function statelessSessions<T>({ secret, maxAge, path, secure, ironOptions, domain, }: StatelessSessionsOptions): () => SessionStrategy<T>;
