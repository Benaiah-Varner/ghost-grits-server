...
} & Omit<import("react").PropsWithoutRef<import("react").ComponentProps<Comp>>, "weight" | "color" | "size" | "as" | keyof import("./Box").ColorProps | keyof import("./Box").RadiiProps | keyof import("./Box").MarginProps | keyof import("./Box").PaddingProps | keyof {
